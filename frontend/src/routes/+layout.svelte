<script lang="ts">
  ...
  const rotatingMessages = fp.filter(msg => msg, [data.copy?.loadingMessage1, data.copy?.loadingMessage2, data.copy?.loadingMessage3, data.copy?.loadingMessage4, data.copy?.loadingMessage5])
